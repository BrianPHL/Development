function RemoveWeaponDrops()
    ...
    -- ? Cycles through all weapons that are in the array to prevent item drops;
    -- ? Loop starts after resource start.
    ...
    for v = 1, #pickupList do

		N_0x616093ec6b139dd9(PlayerId(), GetHashKey(pickupList[v]), false)
...
Citizen.CreateThread(function()     
    ...
    -- ? Removes focus on all UI after resource start.
